<template>
  <div>
    ...
    <modal name="chat-modal" class="chatModal mobile-chat-modal">
        <div class="chat-box">
          <div class="chat-box-settings">
            <ul>
              ...
              <li class="mobile-chat-drawer-settings" style="margin-top: 13px; cursor: pointer; margin-left: -10%; z-index: 10000;" @click="showFriends()">
          ...
          <div class="current-chat">
            ...
            <div v-if="chatMode" class="chat-action">
              <ul>
                ...
                <li class="text-input">
                  <v-col cols="12" sm="6" md="12" lg="12" xl="12" v-if="!isMedia">
                    <v-text-field
                      v-model="chatMessage"
                  ...
                  <ul class="media-icons" v-if="isMedia">
                    ...
                    <li @click="openMedia()" data-toggle="tooltip" data-placement="top" title="Attachments" style="cursor: pointer; color: black !important;"><i class="fas fa-paperclip" @click="openMedia()"></i></li>
                  </ul>
                </li>
                <li class="additional-features" v-if="!isMedia" @click="openMedia()" style="color: black !important; cursor: pointer;">
                  <i class="fas fa-paperclip" @click="openMedia()"></i>
                </li>
    ...
    <!-- Chat Media Modal -->
    <modal name="camera-modal" class="chat-mobile-media-modal" style="margin-top: -5%;">
    ...
    <modal name="audio-modal" class="chat-mobile-media-modal" style="margin-top: -5%;">
    ...
    <modal name="video-modal" class="chat-mobile-media-modal" style="margin-top: -5%;">
      ...
      socket.on('messageReceived', (data) => {
        if (this.chatMode) {
          if (this.chattingWith == data.senderProfile.stageName) {
            ...
            setTimeout(() => {
              var elem = document.querySelector('.mobile-chat-modal .v--modal-box');
              if (elem) {
        ...
        // if (!this.chatMode) {
        //   if (data.senderProfile.stageName != data.messageOwner) {
